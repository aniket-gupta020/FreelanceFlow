...
const PostProject = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      toast.error("Failed to post project: " + (err.response?.data?.message || err.message));
    } finally {
      setLoading(false);
    }
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <input type="date" name="deadline" required className={`${INPUT_CLASSES} dark:[color-scheme:dark]`} onChange={handleChange} />
                </div>
              </div>
